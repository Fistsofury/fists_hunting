	...
	local src = source
		if entType == 3 then -- Fur/Skin/Pelt
			...
			if carriedEntityHash == 957520252 then
				item = 'poor_bear_fur'
				name = 'Poor Bear Fur'
                TriggerEvent('vorp:ShowAdvancedRightNotification', "Bear Fur", "satchel_textures", "tick", "COLOR_PURE_WHITE", 4000)
...
--				-- exports['qbr-core']:Notify(8, 'Big Horn Ram Hide', 5000, name, 'satchel_textures', 'provision_ram_hide', 'COLOR_WHITE')
	...
	--			barname =  'Boar Skin'
			...
			elseif carriedEntityHash == -1730060063 then
                ...
                TriggerEvent('vorp:ShowAdvancedRightNotification', 'you stored a '..name, "satchel_textures", "tick", "COLOR_PURE_WHITE", 4000)
				TriggerServerEvent("fists_hunting:server:storepelt", item)
				DeleteThis(entity)
			...
			elseif carriedEntityHash == 334093551 then
                ...
                TriggerEvent('vorp:ShowAdvancedRightNotification', "Poor Cracker Cow Hide", "satchel_textures", "tick", "COLOR_PURE_WHITE", 4000)
				TriggerServerEvent("fists_hunting:server:storepelt", item)
				DeleteThis(entity)
			elseif carriedEntityHash == 1150594075 then
				...
				-- exports['qbr-core']:Notify(8, 'Cracker Cow Hide', 5000, name, 'satchel_textures', 'provision_cow_hide', 'COLOR_WHITE')
                TriggerEvent('vorp:ShowAdvancedRightNotification', "Good Cracker Cow Hide", "satchel_textures", "tick", "COLOR_PURE_WHITE", 4000)
				TriggerServerEvent("fists_hunting:server:storepelt", item)
				DeleteThis(entity)
			elseif carriedEntityHash == -845037222 then
				...
				-- exports['qbr-core']:Notify(8, 'Cracker Cow Hide', 5000, name, 'satchel_textures', 'provision_cow_hide', 'COLOR_WHITE')
                TriggerEvent('vorp:ShowAdvancedRightNotification', "Perfect Cracker Cow Hide", "satchel_textures", "tick", "COLOR_PURE_WHITE", 4000)
				TriggerServerEvent("fists_hunting:server:storepelt", item)
				DeleteThis(entity)
